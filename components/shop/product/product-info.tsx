  ...
  return (
    <>
      <div className="space-y-4">
        {/* Main product image with fixed dimensions */}
        <div className="relative rounded-lg border bg-muted h-96 w-full flex items-center justify-center overflow-hidden">
          <img
            src={mainImage}
            alt="Product image"
        ...
        <div className="grid grid-cols-4 gap-4">
          {product.images.map((image, index) => (
            <div
              key={index}
              className="relative aspect-square overflow-hidden rounded-lg border bg-muted cursor-pointer h-24"
