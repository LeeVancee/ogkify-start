  ...
  return (
    <div>
            ...
            render={({ field }) => (
              <FormItem>
                <div className="mb-2 flex items-center justify-between gap-3">
                  ...
                  <Link
                    to="/login"
                    className="text-sm text-slate-800 underline underline-offset-4 transition-colors hover:text-slate-950"
                  >
      ...
      <div className="my-8 flex items-center gap-4 text-slate-500">
        ...
        <span className="text-sm">{t("auth.login.continueWith")}</span>
        <div className="h-px flex-1 bg-slate-200" />
      </div>
